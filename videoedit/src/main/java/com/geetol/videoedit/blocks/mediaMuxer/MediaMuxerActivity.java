package com.geetol.videoedit.blocks.mediaMuxer;
...
import com.geetol.videoedit.blocks.mediaMuxer.primary.MuxerVoiceAndVideoToMp4;
import com.geetol.videoedit.blocks.mediaMuxer.primary.MuxerVoiceDbToMp4;
...
public class MediaMuxerActivity extends AppCompatActivity {
    ...
    @OnClick({R2.id.muxer_aac_video_to_mp4, R2.id.muxer_aac_db_to_mp4})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R2.id.muxer_aac_video_to_mp4:
                ...
                break;
            case R2.id.muxer_aac_db_to_mp4:
