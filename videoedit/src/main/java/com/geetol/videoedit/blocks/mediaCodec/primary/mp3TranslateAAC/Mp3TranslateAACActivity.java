package com.geetol.videoedit.blocks.mediaCodec.primary.mp3TranslateAAC;
...
public class Mp3TranslateAACActivity extends AppCompatActivity {
    ...
    @OnClick({R2.id.start1_btn, R2.id.start2_btn,R2.id.start3_btn})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R2.id.start1_btn:
