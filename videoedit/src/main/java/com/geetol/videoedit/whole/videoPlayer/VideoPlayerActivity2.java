...
import com.geetol.videoedit.whole.editVideo.VideoEditActivity;
import com.geetol.videoedit.whole.jiaozivideo.JZVideoPlayer;
import com.geetol.videoedit.whole.jiaozivideo.PublicVideoJZVideo;
import com.geetol.videoedit.whole.selCover.SelCoverTimeActivity;
...
import static com.geetol.videoedit.base.utils.StaticFinalValues.COMR_FROM_SEL_COVER_TIME_ACTIVITY;
import static com.geetol.videoedit.base.utils.StaticFinalValues.COMR_FROM_VIDEO_EDIT_TIME_ACTIVITY;
...
public class VideoPlayerActivity2 extends AppCompatActivity  {
    ...
    @BindView(R2.id.public_video_jz_video)
    ...
    @OnClick({R2.id.video_player2_edit_video_tv,  R2.id.video_player2_sel_cover, R2.id.back_iv,  R2.id.video_player_tv_storage, R2.id.video_player_tv_public})
    public void onViewClicked(View view) {

        switch (view.getId()) {

            case R2.id.video_player2_edit_video_tv:
                ...
                break;
            case R2.id.video_player2_sel_cover:
            ...
            case R2.id.video_player_tv_storage:
                break;
            case R2.id.video_player_tv_public:
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            case COMR_FROM_VIDEO_EDIT_TIME_ACTIVITY:
                videoFilePath = data.getStringExtra(StaticFinalValues.VIDEOFILEPATH);
                playVideo();
                break;
            case COMR_FROM_SEL_COVER_TIME_ACTIVITY:
                videoFilePath = data.getStringExtra(StaticFinalValues.VIDEOFILEPATH);
