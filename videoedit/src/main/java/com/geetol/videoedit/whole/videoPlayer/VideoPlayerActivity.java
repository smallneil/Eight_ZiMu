...
import com.geetol.videoedit.whole.editVideo.view.PopTopTipWindow;
import com.geetol.videoedit.whole.videoPlayer.view.FullScreenVideoView;
...
public class VideoPlayerActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.picture_close)
    ImageView pictureClose;
    @BindView(R2.id.meet_download)
...
//                fullScreenVideoView.setVideoPath(videoFilePath);
    ...
    @OnClick({R2.id.picture_close, R2.id.meet_download})
    public void onClick(View view) {
        switch (view.getId()) {
            case R2.id.picture_close:
                finish();
                break;
            case R2.id.meet_download:
                downloadVideoFile();
                break;
        }
    }
