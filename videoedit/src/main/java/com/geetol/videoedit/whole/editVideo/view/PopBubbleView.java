package com.geetol.videoedit.whole.editVideo.view;
...
//        backgroundAlpha(0.7f);
    ...
    @OnClick({R2.id.ll_bubble_one, R2.id.ll_bubble_two, R2.id.ll_bubble_three, R2.id.ll_bubble_four, R2.id.ll_bubble_five, R2.id.ll_bubble_six, R2.id.ll_bubble_seven, R2.id.ll_bubble_eight})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R2.id.ll_bubble_one:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(0);
                }
                dimss();
                break;
            case R2.id.ll_bubble_two:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(1);
                }
                dimss();
                break;
            case R2.id.ll_bubble_three:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(2);
                }
                dimss();
                break;
            case R2.id.ll_bubble_four:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(3);
                }
                dimss();
                break;
            case R2.id.ll_bubble_five:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(4);
                }
                dimss();
                break;
            case R2.id.ll_bubble_six:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(5);
                }
                dimss();
                break;
            case R2.id.ll_bubble_seven:
                if (bubbleSelectListener != null) {
                    bubbleSelectListener.bubbleSelect(6);
                }
                dimss();
                break;
            case R2.id.ll_bubble_eight:
                if (bubbleSelectListener != null) {
