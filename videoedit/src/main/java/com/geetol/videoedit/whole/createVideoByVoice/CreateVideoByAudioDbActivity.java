package com.geetol.videoedit.whole.createVideoByVoice;
...
import com.geetol.videoedit.whole.createVideoByVoice.frameData.BackgroundFrame;
import com.geetol.videoedit.whole.createVideoByVoice.frameData.MapFrame;
import com.geetol.videoedit.whole.createVideoByVoice.frameData.TopPopFrame;
import com.geetol.videoedit.whole.createVideoByVoice.interfaces.IEncoderVideoCallBackListener;
import com.geetol.videoedit.whole.createVideoByVoice.interfaces.IGetVideoDbCallBackListener;
import com.geetol.videoedit.whole.createVideoByVoice.interfaces.IMuxerVideoCallBackListener;
...
public class CreateVideoByAudioDbActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.create_video_analyze_btn)
    Button mCreateVideoAnalyzeBtn;
    @BindView(R2.id.play_video_btn)
    ...
    @OnClick({R2.id.create_video_analyze_btn, R2.id.play_video_btn})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R2.id.create_video_analyze_btn:
