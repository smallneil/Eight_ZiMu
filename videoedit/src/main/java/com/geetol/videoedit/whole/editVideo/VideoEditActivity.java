package com.geetol.videoedit.whole.editVideo;
...
import com.geetol.videoedit.whole.editVideo.fragment.FilterDialogFragment;
import com.geetol.videoedit.whole.editVideo.mediacodec.VideoClipper;
import com.geetol.videoedit.whole.editVideo.view.BaseImageView;
import com.geetol.videoedit.whole.editVideo.view.BubbleInputDialog;
import com.geetol.videoedit.whole.editVideo.view.BubbleTextView;
import com.geetol.videoedit.whole.editVideo.view.DynamicImageView;
import com.geetol.videoedit.whole.editVideo.view.PopBubbleEditView;
import com.geetol.videoedit.whole.editVideo.view.PopBubbleView;
import com.geetol.videoedit.whole.editVideo.view.PopPasterView;
...
import com.geetol.videoedit.whole.record.filters.GifDecoder;
...
import static com.geetol.videoedit.base.utils.StaticFinalValues.STORAGE_TEMP_VIDEO_PATH;
...
public class VideoEditActivity extends FragmentActivity implements PopBubbleView.BubbleSelectListener, PopPasterView.PasterSelectListener, MediaPlayerWrapper.IMediaCallback, SlideGpuFilterGroup.OnFilterChangeListener, View.OnTouchListener, VideoEditView.OnSelectTimeChangeListener {
    ...
    TextView mTvHint;
    @BindView(R2.id.pop_video_loading_fl)
    ...
    @BindView(R2.id.ll_edit_seekbar)
    VideoEditView videoEditView;
    @BindView(R2.id.ll_select_bar)
    LinearLayout llSelectBar;
    @BindView(R2.id.rl_content_root)
    FrameLayout mContentRootView;
    @BindView(R2.id.bigicon_play)
    ImageView bigiconPlay;
    @BindView(R2.id.video_preview)
    VideoPreviewView mVideoView;
    @BindView(R2.id.ll_add_filter)
    TextView mLlAddFilterTv;
    @BindView(R2.id.pop_video_percent_tv)
...
//            layoutParams.width = (int) (mVideoWidth * StaticFinalValues.VIDEO_WIDTH_HEIGHT);
    ...
    @OnClick({R2.id.rl_content_root, R2.id.iv_back, R2.id.ll_add_sticker, R2.id.ll_add_subtitle, R2.id.edit_video_next_tv, R2.id.ll_play_video, R2.id.ll_add_filter})
