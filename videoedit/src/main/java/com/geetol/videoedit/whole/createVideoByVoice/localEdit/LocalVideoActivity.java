package com.geetol.videoedit.whole.createVideoByVoice.localEdit;
...
import com.geetol.videoedit.whole.createVideoByVoice.localEdit.adapter.ThumbAdapter;
...
import static com.geetol.videoedit.base.utils.StaticFinalValues.ISSAVEVIDEOTEMPEXIST;
import static com.geetol.videoedit.base.utils.StaticFinalValues.VIDEOTEMP;
...
public class LocalVideoActivity extends AppCompatActivity implements MediaPlayerWrapper.IMediaCallback {
    ...
    @BindView(R2.id.local_back_iv)
    ImageView mLocalBackIv;
    @BindView(R2.id.local_rotate_iv)
    ImageView mLocalRotateIv;
    @BindView(R2.id.local_video_next_tv)
    TextView mLocalVideoNextTv;
    @BindView(R2.id.local_title)
    RelativeLayout mLocalTitle;
    @BindView(R2.id.local_video_view)
    VideoPreviewView mLocalVideoView;
    @BindView(R2.id.local_sel_time_tv)
    TextView mLocalSelTimeTv;
    @BindView(R2.id.local_recycler_view)
    RecyclerView mLocalRecyclerView;
    @BindView(R2.id.local_thumb_view)
    ThumbnailView mLocalThumbView;
    @BindView(R2.id.local_frame_layout)
...
//            mLocalVideoView.setRotation(mInitRotation);
    ...
    @OnClick({R2.id.local_back_iv, R2.id.local_rotate_iv, R2.id.local_video_next_tv})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R2.id.local_back_iv:
                onBackPressed();
                break;
            case R2.id.local_rotate_iv:
                isClickRotate = true;
                mRotate = rotate;
                if (rotate < 270) {
                    rotate = rotate + 90;
...
//                mLocalVideoView.setRotation(rotation);
               /* ObjectAnimator animator = ObjectAnimator.ofFloat(mLocalVideoView, "rotation", mRotate, rotation);
                ...
                break;
            case R2.id.local_video_next_tv:
