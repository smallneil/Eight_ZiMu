package com.geetol.videoedit.whole.record;
...
import com.geetol.videoedit.base.pop.PopupManager;
import com.geetol.videoedit.base.utils.FileUtils;
import com.geetol.videoedit.base.utils.StaticFinalValues;
import com.geetol.videoedit.whole.createVideoByVoice.localEdit.LocalVideoActivity;
import com.geetol.videoedit.whole.pickvideo.VideoPickActivity;
import com.geetol.videoedit.whole.pickvideo.beans.VideoFile;
import com.geetol.videoedit.whole.record.beans.MediaObject;
import com.geetol.videoedit.whole.record.other.MagicFilterType;
import com.geetol.videoedit.whole.record.ui.CameraView;
import com.geetol.videoedit.whole.record.ui.CustomRecordImageView;
import com.geetol.videoedit.whole.record.ui.FocusImageView;
import com.geetol.videoedit.whole.record.ui.ProgressView;
import com.geetol.videoedit.whole.record.ui.SlideGpuFilterGroup;
import com.geetol.videoedit.whole.videoPlayer.VideoPlayerActivity2;
...
import static com.geetol.videoedit.base.utils.StaticFinalValues.CHANGE_IMAGE;
import static com.geetol.videoedit.base.utils.StaticFinalValues.DELAY_DETAL;
import static com.geetol.videoedit.base.utils.StaticFinalValues.MAX_NUMBER;
import static com.geetol.videoedit.base.utils.StaticFinalValues.OVER_CLICK;
import static com.geetol.videoedit.base.utils.StaticFinalValues.RECORD_MIN_TIME;
import static com.geetol.videoedit.whole.pickvideo.BaseActivity.IS_NEED_FOLDER_LIST;
import static com.geetol.videoedit.whole.pickvideo.VideoPickActivity.IS_NEED_CAMERA;
...
public class RecorderActivity extends BaseActivity implements View.OnTouchListener, SlideGpuFilterGroup.OnFilterChangeListener {
    ...
    @BindView(R2.id.index_album)
    TextView mIndexAlbum;
    @BindView(R2.id.custom_record_image_view)
    ...
    @OnClick({R2.id.matching_back, R2.id.video_record_finish_iv, R2.id.switch_camera,  R2.id.index_delete, R2.id.index_album, R2.id.custom_record_image_view, R2.id.count_down_tv, R2.id.meet_mask, R2.id.video_filter})
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R2.id.index_album:
                ...
                break;
            case R2.id.custom_record_image_view:
                if(!isRecording) {
                    onStartRecording();
                }else{
                    onStopRecording();
