...
//        popupWindow.setBackgroundDrawable(dw);
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R2.id.cb_release_pornographic_content:    //发布色情内容
                    Log.e(TAG, " 发布色情内容");
                    ...
                    reportType = "0";
                    break;
                case R2.id.cb_issue_violence_content:           //发布暴力内容
                    Log.e(TAG, "发布暴力内容");
    ...
    @OnClick({R2.id.ed_content, R2.id.tv_confirm})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R2.id.ed_content:
                break;
            case R2.id.tv_confirm:
